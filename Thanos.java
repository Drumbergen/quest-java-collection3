...
public class Thanos {
    ...
    public static void main(String[] args) {
        ...
        /*   
        // Test     
        Hero oldest2 = heroes.pollLast();
        Hero oldest3 = heroes.pollFirst();
        System.out.println(oldest2 == null ? "" : oldest2.getName());
        System.out.println(oldest3 == null ? "" : oldest3.getName());
        */
